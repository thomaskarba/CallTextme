...
<html>
<head>
<title><?php if(isset($_SESSION['region'])){
	if($_SESSION['region'] == 'AF' ){echo "CallText.Africa";}
	if($_SESSION['region'] == 'AS' ){echo "CallText.Asia";}
	if($_SESSION['region'] == 'EU' ){echo "CallText.Europe";}
	if($_SESSION['region'] == 'ME' ){echo "CallText.MiddleEast";}
	if($_SESSION['region'] == 'NA' ){echo "CallText.NorthAmerica";}
	if($_SESSION['region'] == 'OC' ){echo "CallText.Oceania";}
	if($_SESSION['region'] == 'SA' ){echo "CallText.SouthAmerica";}
	if($_SESSION['region'] == Null ){echo "CallText.Global";}
	} ?>
</title>
...
echo "<a id='b' href='profile.php'><span style='text-transform:uppercase'><strong>BACK</strong></span></a>";
...
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".str_replace(' ', '',$contact)."&return=".$who."&page=forum_everyone&s=".$s."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";
}	
elseif(substr($contact,0,1) == $trunk){
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".$countrycode.str_replace(' ', '',substr($contact,1))."&return=".$who."&page=forum_everyone&s=".$s."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";	
}else if (substr($contact,0,1) == '+'){
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".str_replace(' ', '',substr($contact,1))."&return=".$who."&page=forum_everyone&s=".$s."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";	
}else{
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".$countrycode.str_replace(' ', '',$contact)."&return=".$who."&page=forum_everyone&s=".$s."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";		
}
	}}}		
...
if($countrycode == substr($contact,0,strlen($countrycode))){
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".str_replace(' ', '',$contact)."&return=".$who."&page=forum_everyone&s=".$who."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";
}	
elseif(substr($contact,0,1) == $trunk){
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".$countrycode.str_replace(' ', '',substr($contact,1))."&return=".$who."&page=forum_everyone&s=".$who."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";	
}else if (substr($contact,0,1) == '+'){
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".str_replace(' ', '',substr($contact,1))."&return=".$who."&page=forum_everyone&s=".$who."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";	
}else{
echo "<a href='http://freeqrcreator.us-west-1.elasticbeanstalk.com/forum?number=%2B".$countrycode.str_replace(' ', '',$contact)."&return=".$who."&page=forum_everyone&s=".$who."'>";
echo "<img src='img/freeqrcreator.png' width='65px'></a>";		
}
	}}}		
