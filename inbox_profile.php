...
<a href="profile.php" id="link"><img src="img/back.png" width="35px"></a>
</div><br>
	...
	echo "<article>THERE ARE NO QUOTES</article>";
		...
		while ($mr = mysqli_fetch_row($mrload)) {
			...
			$quote = $mr['2'];
				$id = $mr['0'];
				$senderlink = $mr['3'];
					echo "<a href='inbox_profile.php?mssg=".$id."&uid=".$uid."'><article>DELETE</article></a><a href='contact_profile.php?uid=".$senderlink."&ib'><div class='qmr'><section><span style='font-size:20px'>".$quote."</span></section></div></a><br><br>";
					$counter++;}
								}
