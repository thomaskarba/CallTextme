...
article{margin:auto;font-family:'Roboto Mono',monospace;width:300px;text-transform:uppercase;color:#8a8a8a;}<!--QMR-->
...
<?php
	...
	// EMAIL
		...
		$body = "http://CallText.me/quote_disclaimer.html DO NOT POST NUDITY OR EXPLICIT IMAGES TO THIS SITE.";	
...
$country = $_SESSION['country'];
	...
	$repeaterlookup = "SELECT * FROM users WHERE country='$country' AND id>'$uid' AND orientation='gay' ORDER BY id ASC LIMIT 1"; 
		$rload = mysqli_query($mysqli,$repeaterlookup);
	if ($rload->num_rows == 1){
		$found = mysqli_fetch_array($rload);
	$who = $found['0'];
...
if(isset($_GET['qmr'])){
	echo "<form action='mviewc_profile.php?uid=".$uid."' method='POST'><textarea name='message' rows='2' cols='45'></textarea><br><input type='submit' name='qmr' value='SEND'></form>";
}
...
echo "<div><div id='topheader'><table><tr><td><a href='mviewc_profile.php?uid=".$uid."&l=1&i=1#a' id='left'><img src='img/left.png' width='30px'></a></td><td><a href='mpcforum.php?return=".$uid."#forum' id='return'><img src='img/central.png' width='30px'></a></td><td><a href='mviewc_profile.php?uid=".$uid."&r=1&i=1#a' id='right'><img src='img/right.png' width='30px'></a></td></tr></table></div><br>";
}elseif(isset($_GET['i'])){
...
echo "<div><div id='topheader'><table><tr><td><a href='mviewc_profile.php?uid=".$uid."&l=1#a' id='left'><img src='img/left.png' width='30px'></a></td><td><a href='mcforum.php?return=".$uid."#forum' id='return'><img src='img/central.png' width='30px'></a></td><td><a href='mviewc_profile.php?uid=".$uid."&r=1#a' id='right'><img src='img/right.png' width='30px'></a></td></tr></table></div><br>";
}
...
if($g >= 25){
	...
	echo "<p id='a'>&nbsp;</p><a href='mforum.php?city=".$city."'><header><span style='font-size:225%'>".$city;
if(isset($country)) {	
	...
	echo "<a href='mcforum.php?add=".$uid."'><article>TOUCH TO SEND CONTACT INFO</article>";
...
if(isset($_GET['p'])){
echo "<footer><a href='mviewc_profile.php?uid=".$uid."&qmr=1&p=1' id='mssg'>WRITE +</a></footer>";	
}else{echo "<footer><a href='mviewc_profile.php?uid=".$uid."&qmr=1' id='mssg'>WRITE +</a></footer>";	
}	*/
...
if(isset($country)) {	
	echo "<br><span style='text-transform:uppercase'>".$country."</span></strong></span></td></tr></table></header></a><br>";
		...
		echo "</span></header></td></tr></table></a>";
	}
			
	if($image != 'prof051487.jpg'){
		echo "<img id='a' width='100%' border='2px' src='profileimg/".$image."'><br>";
	}
...
if($qmr != ''){
echo "<article><span style='font-size:20px'>".$qmr."</span></article><br><br>";
}	
...
//AMAZON iPHONE 7
echo '<iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" src="//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&OneJS=1&Operation=GetAdHtml&MarketPlace=US&source=ac&ref=qf_sp_asin_til&ad_type=product_link&tracking_id=tkimssg-20&marketplace=amazon&region=US&placement=B07VXKJZJH&asins=B07VXKJZJH&linkId=47bbbfcbbb6db86be039c0a2cd508a80&show_border=false&link_opens_in_new_window=true&price_color=333333&title_color=0066c0&bg_color=ffffff"></iframe>';
echo '<br>';
}else{
...
$newmessage = "INSERT INTO phonebook (uid,contact,country,cid) VALUES ('$id','$contact','$country','$who')";
	...
	echo "<br><a href='mviewc_profile.php?uid=".$uid."&pb'><span style='color:black'>ADD TO PHONEBOOK</span></a><br>";
}}}
echo "<br>";
if($share==1){
...
echo "<br><br>";	
//GYR
if($voted != 1 & $_SESSION['id']!=1){
	echo "<a href='mviewc_profile.php?uid=".$uid."&rate=green'><img src='img/g.png' width='20px'></a>&nbsp;&nbsp;";
	if($g < 25){
		echo "&nbsp;&nbsp;&nbsp;";
	echo "<a href='mviewc_profile.php?uid=".$uid."&rate=yellow'><img src='img/y.png' width='20px'></a>&nbsp;&nbsp;";
		echo "&nbsp;&nbsp;&nbsp;";
	echo "<a href='mviewc_profile.php?uid=".$uid."&rate=red'><img src='img/r.png' width='20px'></a>&nbsp;&nbsp;<br>";
	}
	echo "<br>"; 
}else{
	switch ($v) {
...
if(isset($_GET['p'])){
echo "<footer><a href='mviewc_profile.php?uid=".$uid."&qmr=1&p=1' id='mssg'>QUOTE MY RELATIONSHIP +</a></footer>";	
}else{echo "<footer><a href='mviewc_profile.php?uid=".$uid."&qmr=1' id='mssg'>QUOTE MY RELATIONSHIP +</a></footer>";	
}	*/
...
if ($crowd->num_rows > 0){
echo "<h2><article>More numbers in ".$city.", ".$country."</article>";
}
		while($contents = mysqli_fetch_row($crowd)){
...
echo "<br><br>";
echo "<a href='mviewc_profile.php?uid=".$who."&more&cell#cell'><article>More numbers from ".$city."</article></a>";	
...
if(isset($_GET['p'])){
	echo "<br><a href='mviewc_profile.php?uid=".$uid."&report=1&p=1'><span style='color:black'>REPORT IMAGE</span></a><br>";
}else{	echo "<br><a href='mviewc_profile.php?uid=".$uid."&report=1'><span style='color:black'>REPORT IMAGE</span></a><br>";
...
if($fake == 0){
	...
	echo "<br><a href='mviewc_profile.php?uid=".$uid."&fake'><span style='color:black'>REPORT FAKE USER</span></a><br>";
}}elseif($fake == 1){
	if(isset($_GET['real'])){} else {
	echo "<br><a href='mviewc_profile.php?uid=".$uid."&real'><span style='color:black'>REPORT USER REAL</span></a><br>";
}}else{
	echo "<br><a href='mviewc_profile.php?uid=".$uid."&fake'><span style='color:black'>REPORT FAKE USER</span></a><br>";
}}
...
if($bitcoin != "0"){
echo "<br><br><span style='color:#ff69b4'><strong>DONATE ME</strong></span><br><img width='250px' src='img/BC.png'><br><span style='color:#ff69b4;font-size: 10pt'><br>Address:<br>".$bitcoin."</span>";		
}else{
echo "<br><br><span style='color:#ff69b4'><strong>DONATE HERE</strong></span><br><img width='250px' src='img/BC.png'><br><span style='color:#ff69b4;font-size: 10pt'><br>Address:<br>3JVj1pV8E3SuaNPmnz15FLNBdFU5rDkGSM<br>calltextme.crypto</span>";	
}
...
if($sex == 'M'){
	echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='mfchange' value='M' checked>MALE<input type='radio' name='mfchange' value='F'>FEMALE<input type='submit' name='mf' value='CHANGE'></form>";				 
}		

if($sex == 'F'){
	echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='mfchange' value='M'>MALE<input type='radio' name='mfchange' value='F' checked>FEMALE<input type='submit' name='mf' value='CHANGE'></form>";				 
}

if($regioncode == 'AF'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF' checked>AFRICA<input type='radio' name='region' value='AS'>ASIA<input type='radio' name='region' value='EU'>EUROPE<input type='radio' name='region' value='ME'>MIDDLE EAST<input type='radio' name='region' value='NA'>NORTH AMERICA<input type='radio' name='region' value='SA'>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
if($regioncode == 'AS'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF'>AFRICA<input type='radio' name='region' value='AS' checked>ASIA<input type='radio' name='region' value='EU'>EUROPE<input type='radio' name='region' value='ME'>MIDDLE EAST<input type='radio' name='region' value='NA'>NORTH AMERICA<input type='radio' name='region' value='SA'>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
if($regioncode == 'EU'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF'>AFRICA<input type='radio' name='region' value='AS'>ASIA<input type='radio' name='region' value='EU' checked>EUROPE<input type='radio' name='region' value='ME'>MIDDLE EAST<input type='radio' name='region' value='NA'>NORTH AMERICA<input type='radio' name='region' value='SA'>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
if($regioncode == 'ME'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF'>AFRICA<input type='radio' name='region' value='AS'>ASIA<input type='radio' name='region' value='EU'>EUROPE<input type='radio' name='region' value='ME' checked>MIDDLE EAST<input type='radio' name='region' value='NA'>NORTH AMERICA<input type='radio' name='region' value='SA'>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
if($regioncode == 'NA'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF'>AFRICA<input type='radio' name='region' value='AS'>ASIA<input type='radio' name='region' value='EU'>EUROPE<input type='radio' name='region' value='ME'>MIDDLE EAST<input type='radio' name='region' value='NA' checked>NORTH AMERICA<input type='radio' name='region' value='SA'>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
if($regioncode == 'OC'){echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='radio' name='region' value='AF'>AFRICA<input type='radio' name='region' value='AS'>ASIA<input type='radio' name='region' value='EU'>EUROPE<input type='radio' name='region' value='ME'>MIDDLE EAST<input type='radio' name='region' value='NA'>NORTH AMERICA<input type='radio' name='region' value='SA' checked>SOUTH AMERICA<input type='radio' name='region' value='OC'>OCEANIA<input type='submit' name='re' value='SET'></form>";}
...
echo "<form action='mviewc_profile.php' method='GET'><input type='hidden' name='uid' value='$uid'><input type='text' name='country' placeholder='".$country."'><br><input type='submit' name='countryinput' value='Country'></form>";
