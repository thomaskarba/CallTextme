...
if(isset($_POST['write'])){
	...
	$_SESSION['location'] = $location;
		if(($test != Null)||($contact != Null)||($location != Null)) {
			...
			if($contact != Null && $location != Null && $test == Null) {
				exit('PLEASE WRITE A QUOTE, ALSO');
			}
...
<a href="https://youtu.be/ZaydwmR1ZPA" target="_parent"><span style="color:white">How to Use</span></a>
